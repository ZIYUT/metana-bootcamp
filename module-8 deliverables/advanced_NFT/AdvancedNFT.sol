...
import "@openzeppelin/contracts@5.1.0/utils/structs/BitMaps.sol";
import "@openzeppelin/contracts@5.1.0/access/Ownable.sol";
import "@openzeppelin/contracts@5.1.0/utils/Multicall.sol";
...
contract AdvancedNFT is ERC721, Ownable, Multicall {
    ...
    // Merkle tree root for airdrop whitelist
    ...
    // Tracking minted addresses (choose one: mapping or bitmap)
    mapping(address => bool) public hasMintedMapping; // Option 1: Mapping
    BitMaps.BitMap private hasMintedBitmap;          // Option 2: Bitmap
    ...
    constructor(bytes32 _merkleRoot, address _designatedAddress) payable ERC721("AdvancedNFT", "ANFT") Ownable(msg.sender) {
